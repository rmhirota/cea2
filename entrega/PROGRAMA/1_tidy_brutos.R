...
da_metadados <- tbl_arquivos_brutos(dir = "DADOS/copia_dados_brutos/")
...
readr::write_csv(da_tidy, "DADOS/da_tidy.csv")
# usethis::use_data(da_metadados, overwrite = TRUE)
readr::write_csv(da_metadados, "DADOS/da_metadados.csv")
# usethis::use_data(da_agrupado, overwrite = TRUE)
readr::write_csv(da_agrupado, "DADOS/da_agrupado.csv")
