...
- A pressão média na condição basal é mais alta que na contingente
]
...
- Não foram obtidos dados de dois bebês nesse grupo no segundo e no terceiro dia
...
- Não há uma diferença clara do dia 1 para o dia 3
...
da_apertos <- cea2::da_spss %>% 
  ...
  dplyr::transmute(nome, grupo, dia = stringr::str_c("dia", dia), n_apertos) %>% 
