...
d12 <- da_apertos %>% 
  ...
  ggplot2::geom_hline(ggplot2::aes(
    linetype = "mediana", 
    yintercept = median(dia2, na.rm = TRUE)
  ), alpha = .3) +
  ggplot2::geom_vline(ggplot2::aes(
    linetype = "mediana", 
    xintercept = median(dia1, na.rm = TRUE)
  ), alpha = .3) +
  ggplot2::scale_linetype_manual(name = "", values = 3)
...
d23 <- da_apertos %>% 
  ...
  ggplot2::geom_hline(ggplot2::aes(
    linetype = "mediana", 
    yintercept = median(dia3, na.rm = TRUE)
  ), alpha = .3) +
  ggplot2::geom_vline(ggplot2::aes(
    linetype = "mediana", 
    xintercept = median(dia2, na.rm = TRUE)
  ), alpha = .3) +
  ggplot2::scale_linetype_manual(name = "", values = 3)
