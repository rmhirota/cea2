...
- Definição de uma nova variável: Tempo entre apertos, calculado a partir dos dados originais cortados
...
- A extensão dos boxplots indica uma grande variabilidade nessa variável.
]
